    ...
    <div>
       <div className="bg-black px-4 py-16">
        ...
        <section className="mb-12">
            ...
            <p className="mb-4">These Terms and Conditions, along with privacy policy or other terms (&ldquo;Terms&rdquo;) constitute a binding agreement by and between PROMODADDY DIGITAL LLP, (&ldquo;Website Owner&rdquo; or &ldquo;we&rdquo; or &ldquo;us&rdquo; or &ldquo;our&rdquo;) and you (&ldquo;you&rdquo; or &ldquo;your&rdquo;) and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, &ldquo;Services&rdquo;).</p>
            <p>By using our website and availing the Services, you agree that you have read and accepted these Terms (including the Privacy Policy). We reserve the right to modify these Terms at any time and without assigning any reason. It is your responsibility to periodically review these Terms to stay informed of updates.</p>
        </section>

        <section className="mb-12">
            <h2 className="text-xl font-semibold mb-4">Use of Website and Services</h2>
        ...
        <section className="mb-12">
            <h2 className="text-xl font-semibold mb-4">Payment and Usage</h2>
        ...
        <section className="mb-12">
            <h2 className="text-xl font-semibold mb-4">Transactions and Refunds</h2>
            ...
            <p>You shall be entitled to claim a refund of the payment made by you in case we are not able to provide the Service. The timelines for such return and refund will be according to the specific Service you have availed or within the time period provided in our policies (as applicable).</p>
            <p>In case you do not raise a refund claim within the stipulated time, than this would make you ineligible for a refund.</p>
        </section>
        ...
        <section className="mb-12">
            ...
            <p>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Kota, Rajasthan</p>
        </section>
