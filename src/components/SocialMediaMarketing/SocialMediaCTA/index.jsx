    ...
    <section className="relative overflow-hidden bg-[#0b0b0b] py-20 text-white md:py-24">
      ...
      <SharedLayout>
        <div className="relative z-10 mx-auto max-w-5xl text-center">
          ...
          {/* Main content */}
          <p className="mx-auto mt-6 max-w-4xl text-base leading-8 text-gray-300 sm:text-lg">
            Get a{" "}
            <span className="font-semibold text-white">
              FREE social media audit
            </span>{" "}
            and we will analyze your current profiles, compare competitors, and
            show you exactly what content strategy will grow your followers and
            generate real leads.
          </p>
