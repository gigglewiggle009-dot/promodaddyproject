...
const pricingPlans = [
  {
    ...
    bestFor: "Local businesses, single campaign",
  },
  {
    name: "Growth",
    fee: "Rs.6,000/month",
    adSpend: "Rs.25,000/month",
    bestFor: "SMBs, coaching institutes, multiple campaigns",
    featured: true,
  },
  {
    name: "Pro",
    ...
    bestFor: "E-commerce, competitive markets, full funnel",
  },
  {
    name: "Enterprise",
    fee: "Custom",
    adSpend: "Rs.1,50,000+",
    bestFor: "National brands, multi-location businesses",
  },
];
