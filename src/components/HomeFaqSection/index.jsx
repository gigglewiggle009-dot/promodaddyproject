...
export const HomeFaqSection = () => {
  ...
  return (
    <section className="bg-[#0b0b0b] text-white py-16 sm:py-20 md:py-24 relative overflow-hidden">
      {/* subtle glow bg */}
              ...
              return (
                <div key={index}>
                  ...
                  >
                    ...
                    {/* ICON */}
                    <div className="w-8 h-8 flex items-center justify-center rounded-full border border-white/30 text-white text-xl font-semibold transition-transform duration-300">
                      {isOpen ? "−" : "+"}
                    </div>
                  </button>
